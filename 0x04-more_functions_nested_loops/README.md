...
Task6: A unction that draws a straight line in the terminal
...
Task8: A  function that prints a square, followed by a new linePrototype: void print_square(int size);
You can only use _putchar function to print
